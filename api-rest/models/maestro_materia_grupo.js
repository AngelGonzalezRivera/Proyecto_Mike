...
return  db.get().query("Insert into maestro_materia_grupo values(?,?,?,?,?)",[null,maestro_materia_grupo.id_maestro,maestro_materia_grupo.id_materia,maestro_materia_grupo.id_grupo],callback);
},
...
updatemaestro_materia_grupo:function(id,maestro_materia_grupo,callback){
 return  db.get().query("update maestro_materia_grupo set id_maestro=?,id_materia=?,id_grupo=? where id=?",[maestro_materia_grupo.id_maestro,maestro_materia_grupo.id_materia,maestro_materia_grupo.id_grupo,id],callback);
},
